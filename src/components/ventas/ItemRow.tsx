...
export default function ItemRow({ item, mobile = false }: Props) {
  ...
  if (mobile) {
    return (
      <div className="p-4 space-y-3">
        ...
        {editando ? seguimientoForm : seguimientoDisplay}
      </div>
    )
  }
  ...
  return (
    <tr className="border-b border-gray-100 last:border-0">
      ...
      <td className="px-5 py-4">{estadoSelect}</td>
      <td className="px-5 py-4">{editando ? seguimientoForm : seguimientoDisplay}</td>
    </tr>
  )
}
